...
### Changed
- Removed all custom localization content to comply with Raycast guidelines
- Updated package.json to use English-only descriptions and keywords
- Simplified toast messages to English only
- Improved extension description to better highlight unique floating window feature
